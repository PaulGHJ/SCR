...
parser.add_argument('--checkpoint-dir', default='./simclr_cifar100_swd/lincls/', type=Path,
...
def main_worker(gpu, args):
    ...
    optimizer = optim.SGD(param_groups, 0.1, momentum=0.9, weight_decay=args.weight_decay)
